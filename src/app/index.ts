  ...
  public configuration() {
    ...
    this.app.all("/*", (req, res, next) => {
      ...
      res.header(
        ...
        "Origin, X-Requested-With, Content-Type, Accept,Access-Control-Allow-Headers, authorization, token, language, x-device-type, x-app-version, x-build-number, uuid,x-auth-token,X-L10N-Locale",
      );
      res.header(
